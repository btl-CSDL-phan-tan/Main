...
ACTUAL_ROWS_IN_INPUT_FILE = 10000054  # Number of lines in the input file: "10000054 trong ratings.dat"
...
if __name__ == '__main__':
    try:
        ...
        with testHelper.getopenconnection(dbname=DATABASE_NAME) as conn:
            ...
            [result, e] = testHelper.testroundrobininsert(MyAssignment, RATINGS_TABLE, 100, 1, 3, conn, '4')     # (100 + 10000054) % 5 = 4
            # (10000054 + x) % N = ???
